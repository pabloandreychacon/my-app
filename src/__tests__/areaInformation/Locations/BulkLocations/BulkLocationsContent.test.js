...
import BulkLocationsContent from "../../../../../views/workstation/AreaInformation/Locations/BulkLocationsTab/BulkLocationsContent";

configure({ adapter: new Adapter() });
const expect = global.expect;

describe("Workstation / Area Information / Locations / BulkLocationsFiltersComponent / BulkLocationsFiltersComponent", () => {
  ...
  beforeEach(() => {
    wrapper = mount(<BulkLocationsContent />);
  });

  // Locations Component
  it("Verify BulkLocationsFiltersComponent renders", () => {
    expect(wrapper).not.toBeNull();
  });

  // Output - Renders the correct components for this whole section
  describe("Verify BulkLocationsFiltersComponent renders correct base components", () => {
    it("Renders BulkLocationsFilters Component", () => {
      const BulkLocationsFiltersComponent = wrapper.find(
        "BulkLocationsFilters"
      );
      expect(BulkLocationsFiltersComponent.exists()).toBe(true);
    });
  ...
  // BulkLocationsFilters Component
  describe("Tests BulkLocationsFilters Component", () => {
    // Collapse button
    ...
    describe("Verify onAreaChange functionality", () => {
      it("Verify getFilteredData gets called after areaFilter has changed", () => {
        const singleTableComponent = wrapper.find("SingleTable");
        const locationsFilterComponent = wrapper.find("BulkLocationsFilters");
        ...
        // areaFilter === 'LSD'
        locationsFilterComponent.invoke("onAreaChange")("XYZ");
